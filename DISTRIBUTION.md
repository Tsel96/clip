...
Releases + a Netlify/Vercel landing page.
...
deploying, replace the two placeholders in `index.html`:
...
Deploy: drag `site/` into Netlify, or connect the repo (publish dir = `site`).
