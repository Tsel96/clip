...
// (CardStickyContentView / CardTextContentView deleted: never constructed —
// makeNativeCardContent returns nil for .stickyNote/.text, which render via
// SwiftUI StickyNodeView/TextNodeView. Removed in the improve-audit pass.)
