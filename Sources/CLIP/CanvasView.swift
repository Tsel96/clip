            ...
            ZStack(alignment: .topLeading) {
                ...
                if state.canvasMode != .archive {
                        ...
                        CollectionCanvas(config: CanvasConfig(
                            ...
                            onZoomInteracting: { active in
                                active ? state.nativeZoomBegan() : state.nativeZoomEnded()
                            },
                            content: { node in
                            ...
                            trimmingNodeID: state.trimmingCardID,
                ...
                // (Sticky actions are shown by SWAPPING the bottom toolbar's
                // icons/functions when a sticky is selected — not a floating bar.)
